...
public class ViewSetaEsquerda extends PortView {
	
	Renderer renderer;
	
	public ViewSetaEsquerda(Object cell) {
		super(cell);
	...
	class Renderer extends PortRenderer implements CellViewRenderer {
		...
		public Renderer() {
			...
			imagem = new ImageIcon(
					this.getClass().getClassLoader().getResource("on_tool/imagens/Continuous22.gif"));
		}
